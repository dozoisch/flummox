...
var FluxComponent = (function (_React$Component) {
  ...
  FluxComponent.prototype.wrapChild = function wrapChild(child) {
    return _React2['default'].addons.cloneWithProps(child, this.getChildProps());
  };
  ...
  FluxComponent.prototype.getChildProps = function getChildProps() {
    ...
    return _assign2['default']({ flux: this.getFlux() }, // TODO: remove in next major version
...
_assign2['default'](FluxComponent.prototype, _instanceMethods$staticProperties.instanceMethods);

_assign2['default'](FluxComponent, _instanceMethods$staticProperties.staticProperties);
